                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <div class="intro-message" style="padding-left: 15%;color: white;">
                            <h1 style="padding-left: 25%;"><strong>学生登陆页面</strong></h1>
                            <div style="margin-bottom: 30px; background-color: #EBEBEB;"></div>
                            <div class="description">
                                <p style="font-size: 14px;"> 欢迎进入学生登陆页面，输入正确的工号和姓名后，点击登陆按钮即可登陆。
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3>登 陆</h3>
                                <p style="font-size: 14px;">请 输 入 正 确 的 工 号 和 姓 名：</p>
                            </div>
                        ...
                        <div class="form-bottom">
                            <form action="/student/login" method="post">
                                <div class="form-group"><label class="sr-only">Username</label>
                                    <input id="id" type="text" name="id" placeholder="工号..." class="form-control"></div>
                                <div class="form-group"><label class="sr-only">Password</label>
                                    <input id="name" type="text" name="name" placeholder="密码..." class="form-username form-control"></div>
